...
module.exports = {
	...
	async execute(client, message, args) {
		...
		if (!levelSchema) levelSchema = await new Levels({ userId: message.author.id, xp: 0, shopDiscount: 0, msgDiscount: 0, serverId: message.guild.id }).save().catch((e) => console.log(e))
